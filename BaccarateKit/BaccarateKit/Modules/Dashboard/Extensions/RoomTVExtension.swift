//
//  RoomTVExtension.swift
//  BaccaratLiveStream
//
//  Created by Farmood on 6/9/23.
//

// swiftlint:disable superfluous_disable_command cyclomatic_complexity type_body_length file_length type_name large_tuple line_length
import Foundation
import SpreadsheetView
extension RoomTVCell: SpreadsheetViewDataSource, SpreadsheetViewDelegate {
...
extension RoomTVCell {
    ...
    func setStatus() {
        ...
        if self.casinoTabledata?.status != nil && self.casinoTabledata?.status == 0 {
            ...
            gameStatusLabel.text = "Under maintenance".localizable
        } else {
            ...
            case 0:
                ...
                statusView.isHidden = false
                gameStatusLabel.text = "Shuffling".localizable
